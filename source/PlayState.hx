...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'payment':
				dialogue = CoolUtil.coolTextFile(Paths.txt('payment/paymentDialogue'));
			case 'collector':
				dialogue = CoolUtil.coolTextFile(Paths.txt('collector/collectorDialogue'));
			case 'overdue':
				dialogue = CoolUtil.coolTextFile(Paths.txt('overdue/overdueDialogue'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'avenue':
			{
						defaultCamZoom = 0.9;
						curStage = 'avenue';
						var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('avenue/bg'));
						bg.antialiasing = true;
